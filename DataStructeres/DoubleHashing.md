...
In _Double Hashing_, we resolve the collisions by using second _Hash Function_ and adding the result from second _Hash Function_ into the previous _Hash Function_. In our case the new _Hash Function_ will be the following:
